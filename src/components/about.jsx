    ...
    <div className="home">
      <section className="intro">
        <div className="intro-grid">
          <div className="bio">
            <p>
              I am a senior computer science student focusing on ML and Vision. I am currently working at{' '}
            ...
            <p>
              I also do web dev and currently building my own B2B SAAS startup (stealth).
            </p>
            <p>
            ...
            <div className="links-list-section" style={{ marginTop: '2rem' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                ...
                <li><a href="https://github.com/arigon79/" target="_blank" rel="noopener noreferrer" className="email-link">github</a></li>
